...
mycursor.execute("CREATE TABLE mentor(mentor_id INT PRIMARY KEY AUTO_INCREMENT, mentor_fname NVARCHAR(30), mentor_lname NVARCHAR(30))")
...
mycursor.execute("CREATE TABLE course(course_id INT PRIMARY KEY AUTO_INCREMENT, course_name NVARCHAR(30), course_details NVARCHAR(200))") 
